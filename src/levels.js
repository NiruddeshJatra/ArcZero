...
export const LEVELS = [
  ...
  // L3 — Crosswinds
  { label: 'LEVEL 3 — CROSSWINDS',    spawnInterval: 2.5,  missileVyMin: -20, missileVyMax: -10, missileVxRange: 10, maxMissiles: Infinity, scoreThreshold: 650,   minIntercepts: 24,  minWaves: 3, tint: '#0a1028', intro: 'Track the drift.' },
  // L4 — Saturation
  { label: 'LEVEL 4 — SATURATION',    spawnInterval: 2.25, missileVyMin: -25, missileVyMax: -10, missileVxRange: 15, maxMissiles: 7,        scoreThreshold: 950,   minIntercepts: 30,  minWaves: 3, tint: '#0f0a2a', intro: 'Prioritize. Or fall.' },
  // L5 — Couriers
  { label: 'LEVEL 5 — COURIERS',      spawnInterval: 2.25, missileVyMin: -30, missileVyMax: -15, missileVxRange: 15, maxMissiles: 8,        scoreThreshold: 1300,  minIntercepts: 36,  minWaves: 3, tint: '#1a0a2c', intro: 'Gold streaks. Fast.',          eventWeights: { courier: 0.2 } },
  // L6 — Splitters
  { label: 'LEVEL 6 — SPLITTERS',     spawnInterval: 2.1,  missileVyMin: -28, missileVyMax: -12, missileVxRange: 15, maxMissiles: 9,        scoreThreshold: 1750,  minIntercepts: 42,  minWaves: 4, tint: '#220a1f', intro: 'One becomes three.',            eventWeights: { splitter: 0.25 } },
  // L7 — MIRV Storm
  { label: 'LEVEL 7 — MIRV STORM',    spawnInterval: 2.0,  missileVyMin: -30, missileVyMax: -15, missileVxRange: 18, maxMissiles: 10,       scoreThreshold: 2300,  minIntercepts: 48,  minWaves: 4, tint: '#2a0a15', intro: 'Watch the sky fracture.',        eventWeights: { mirv: 0.20 } },
  // L8 — Blackout
  { label: 'LEVEL 8 — BLACKOUT',      spawnInterval: 2.0,  missileVyMin: -30, missileVyMax: -15, missileVxRange: 18, maxMissiles: 10,       scoreThreshold: 2900,  minIntercepts: 54,  minWaves: 4, tint: '#18081a', intro: 'Trust the feel.',               forceTrajectoryOff: true },
  // L9 — Onslaught
  { label: 'LEVEL 9 — ONSLAUGHT',     spawnInterval: 1.9,  missileVyMin: -32, missileVyMax: -15, missileVxRange: 20, maxMissiles: 10,       scoreThreshold: 3700,  minIntercepts: 60,  minWaves: 5, tint: '#280828', intro: 'All of it. At once.',            eventWeights: { courier: 0.15, splitter: 0.15, mirv: 0.10 } },
  // L10 — Endless
